...
// Avvia il timer
const setTimer = () => {
  let containerTimer = document.querySelector('#timer span');//contenitore per secondi
  let circle = document.querySelector('.circle')//aggiunto al codice già esistente, seleziona contenitore timer
